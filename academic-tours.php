    ...
    <style>
        ...
        .hero {
            ...
            background:
                ...
                url('images/del2.jpg') center/cover no-repeat;
            padding: 90px 20px;
            color: #fff;
            text-align: left;
...
<body>
    ...
    <section class="hero">
        <div class="content">
            <p>Home &raquo; Educational Travel &raquo; Academic / Study Tours</p>
            <h1>Academic & Study Tours</h1>
            <span class="pill">10–14 Days — Global Learning & Cultural Exchange</span>
        </div>
    </section><br>
    ...
    <section class="scroll-gallery">
        <div class="scroll-track">
            ...
            <div class="gallery-item">
                <img src="images/conf.jpg" alt="Pilgrimage Group">
                <span> </span>
            </div>

            <div class="gallery-item">
                <img src="images/del3.jpg" alt="Pilgrimage Group">
                <span> </span>
            </div>

            <div class="gallery-item">
                <img src="images/menu4.jpg" alt="Pilgrimage Group">
                <span> </span>
            </div>
            <div class="gallery-item">
                <img src="images/conf.jpg" alt="Pilgrimage Group">
    ...
    <section class="content-section">
        <article class="post">
            <h2 class="mb-3">FEATURING: Educational Tours — Universities, Research Centers, Museums & Industry Visits
            </h2>
            <p class="lead">These tours are created to bridge theory and practice — giving learners hands-on exposure in
                their field
                of study while experiencing global cultures and institutions.</p>
            <div class="card">
                <h2>Purpose of the Study Tour</h2>
                <p>
                    Participants will engage with international faculty, visit renowned research centers, and
                    participate in academic workshops. Each destination provides unique insight into global trends,
            ...
            <section class="itinerary">
                ...
                <div class="day">
                    <div class="day-header">Day 1: Departure & Arrival <span>+</span></div>
                    <div class="day-content">
                        Depart from Nairobi. Upon arrival, orientation and introduction
                        to the host institution.<br>
                        <strong>Meals:</strong> Dinner
                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Day 1–2: Departure & Arrival <span>+</span></div>
                    <div class="day-content">
                        Participate in academic lectures, panel discussions, and guided
                        tours of university campuses.<br>
                        <!-- <strong>Meals:</strong> Breakfast, Lunch, Dinner -->
                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Day 3–5: Academic Engagements<span>+</span></div>
                    <div class="day-content">
                ...
                <div class="day">
                    <div class="day-header">Day 6–8: Industry Visits<span>+</span></div>
                    <div class="day-content">
                        Visit innovation hubs, government agencies, and leading companies
                        relevant to participants’ fields of study.<br>
                        <!-- <strong>Meals:</strong> Breakfast, Lunch, Dinner -->
                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Day 9–11: Cultural Immersion <span>+</span></div>
                    <div class="day-content">
                        Explore heritage sites, museums, and community projects. Engage
                        in cultural exchange and team activities.<br>
                        <!-- <strong>Meals:</strong> Breakfast, Lunch, Dinner -->
                    </div>
                </div>
                ...
                <div class="day">
                    <div class="day-header">Day 14: Return <span>+</span></div>
                    <div class="day-content">
                        Farewell session and departure for Nairobi.<br>
                        <!-- <strong>Meals:</strong> Breakfast, Lunch, Dinner -->
                    </div>
                </div>
        ...
        <aside class="sidebar">
            <div class="card">
                ...
                <ul>
                    ...
                    <li><strong>Destinations:</strong> Europe, Asia, North America</li>
                    <li><strong>Includes:</strong> Flights, Accommodation, Learning Visits, Meals</li>
                </ul>
            </div>
            ...
            <div class="card">
                ...
                <p>
                    Our Academic and Study Tours are designed for schools, universities, and professional
                    institutions seeking to expand classroom learning into real-world experiences.
                    These programs blend education, culture, and adventure — helping students and educators
                    explore innovation, global history, and leadership development.
                </p>
            </div>
            <div class="card">
                <h4>Contact</h4>
