    ...
    <style>
        ...
        .hero {
            ...
            background:
                ...
                url('images/mombasa-diani.jpg') center/cover no-repeat;
            padding: 90px 20px;
            color: #fff;
            text-align: left;
...
<body>
    ...
    <section class="hero">
        <div class="content">
            <p>Home &raquo; Kenya Tours &raquo; Mombasa Excursions</p>
            <h1>Mombasa Coastal Excursions</h1>
            <span class="pill">Cultural, Historical & Marine Adventure Tours</span>
        </div>
    </section><br>
    ...
    <section class="scroll-gallery">
        <div class="scroll-track">
            ...
            <div class="gallery-item">
                <img src="images/mombasa-fort.jpg" alt="Pilgrimage Group">
            ...
            <div class="gallery-item">
                <img src="images/swahili.jpg" alt="Pilgrimage Group">
    ...
    <section class="content-section">
        <article class="post">
            <h2>Experience the Magic of the Coast</h2>
            <p class="lead">Explore Mombasa’s rich heritage, from ancient Swahili architecture and spice markets to
                coral
                reefs and pristine beaches. Perfect for travelers seeking culture, relaxation, and adventure in one
                getaway.</p>
            <!-- <div class="card">
            ...
            <section class="itinerary">
                ...
                <div class="day">
                    <div class="day-header">Morning: Fort Jesus & Old Town Tour<span>+</span>
                    </div>
                    <div class="day-content">
                        Visit Fort Jesus, a UNESCO World Heritage site, and stroll through narrow streets filled with
                        Arabic,
                        Portuguese, and African influences. Discover antique shops and traditional Swahili doors.<br>
                        <!-- <strong>Meals:</strong> Dinner -->
                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Midday: Spice Market & Local Cuisine<span>+</span></div>
                    <div class="day-content">
                        Sample tropical spices, coconut delicacies, and Swahili dishes at a local restaurant overlooking
                        the ocean..<br>
                ...
                <div class="day">
                    <div class="day-header">Afternoon: Marine Adventure or Beach Relaxation<span>+</span></div>
                    <div class="day-content">
                        Go snorkeling or take a glass-bottom boat ride at Mombasa Marine Park, or simply relax at Diani
                        Beach with
                        turquoise waters and soft sands.<br>
                        <!-- <strong>Meals:</strong> Breakfast, Lunch, Dinner -->
                    </div>
                </div>
        ...
        <aside class="sidebar">
            <div class="card">
                ...
                <ul>
                    ...
                    <li><strong>Departure:</strong> Mombasa / Diani</li>
                    <li><strong>Destinations:</strong> Fort Jesus, Old Town, Marine Parks</li>
                    <li><strong>Includes:</strong> Transport, Entry Fees, Guide, Refreshments</li>
                </ul>
            </div>

            <div class="card">
                <h2>About the Mombasa Excursion</h2>
                <p>Immerse yourself in the charm of Kenya’s coast — where white-sand beaches meet centuries of
                    Swahili
                    culture. From exploring the historic Fort Jesus to cruising the Indian Ocean, Mombasa offers
                    a perfect
                    mix of heritage, relaxation, and marine adventure.</p>
            </div>
            <div class="card">
                <h4>Contact</h4>
