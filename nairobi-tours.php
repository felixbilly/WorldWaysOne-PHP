    ...
    <style>
        ...
        .hero {
            ...
            background:
                ...
                url('images/nairobi-banner.jpg') center/cover no-repeat;
            padding: 90px 20px;
            color: #fff;
            text-align: left;
...
<body>
    ...
    <section class="hero">
        <div class="content">
            <p>Home &raquo; Kenya Tours &raquo; Nairobi Excursion Tours</p>
            <h1>Nairobi Excursion Tours</h1>
            <span class="pill">Full & Half Day Cultural & Adventure Experiences</span>
        </div>
    </section><br>
    ...
    <section class="scroll-gallery">
        <div class="scroll-track">
            ...
            <div class="gallery-item">
                <img src="images/Nairobi-Giraffe.webp" alt="Pilgrimage Group">
                <span>Rome - Vatican City</span>
            </div>

            <div class="gallery-item">
                <img src="images/lion-nairobi.jpg" alt="Pilgrimage Group">
                <span>Lourdes - Candlelight Procession</span>
            </div>

            <div class="gallery-item">
                <img src="images/bomas-of-kenya.gif" alt="Pilgrimage Group">
                <span>Fatima Sanctuary</span>
            </div>

            <div class="gallery-item">
                <img src="images/beach.jpg" alt="Pilgrimage Group">
    ...
    <section class="content-section">
        <article class="post">
            <h2 class="mb-3">Adventure Awaits in Nairobi
            </h2>
            <p class="lead">Spend your day exploring Nairobi’s natural beauty, cultural heritage, and wildlife within
                reach of
                the city center. This experience blends leisure, learning, and local flavor — all in one memorable day.
            </p>
            <!-- <div class="card">
            ...
            <section class="itinerary">
                ...
                <div class="day">
                    <div class="day-header">Morning: Giraffe Centre & David Sheldrick Elephant Orphanage <span>+</span>
                    </div>
                    <div class="day-content">
                        Start your morning meeting giraffes up close and learning conservation efforts at David
                        Sheldrick
                        Wildlife
                        Trust. Enjoy light snacks and photography moments.<br>
                        <!-- <strong>Meals:</strong> Dinner -->
                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Midday: Nairobi National Park Drive <span>+</span></div>
                    <div class="day-content">
                        Enjoy a thrilling safari just minutes from the city. Spot lions, rhinos, and buffalos against
                        the
                        iconic
                        Nairobi skyline backdrop.<br>
                        <!-- <strong>Meals:</strong> Breakfast, Lunch, Dinner -->
                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Afternoon: Bomas of Kenya & Cultural Performance<span>+</span></div>
                    <div class="day-content">
                        Experience Kenya’s colorful heritage through traditional dance, music, and village replicas at
                        Bomas of
                        Kenya. Perfect conclusion to your day of discovery.<br>
                        <!-- <strong>Meals:</strong> Breakfast, Lunch, Dinner -->
                    </div>
                </div>
                ...
                <div class="container">
                    <form id="bookingForm" method="POST" action="send_booking.php" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-75"><input type="number" id="phone" name="phone"
                                    placeholder="+254/072344..">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-75">
                                <select class="form-select" id="destination" name="destination" required>
                                    <option value="Nairobi">Nairobi Excursion</option>
                                    <option value="Mombasa">Mombasa Excursion</option>
                                    <option value="Safari">Safari Adventure</option>

                                    <option value="custom">Other Customized</option>
                                </select>
                            </div>
                        </div>
        ...
        <aside class="sidebar">
            <div class="card">
                <h3>Excursion Information</h3>
                <ul>
                    <li><strong>Duration:</strong> Half / Full Day</li>
                    <li><strong>Departure:</strong> Nairobi</li>
                    <li><strong>Destinations:</strong> Giraffe Centre, National Park, Bomas of Kenya</li>
                    <li><strong>Includes:</strong> Transport, Entry Fees, Guided Tour</li>
                </ul>
            </div>

            <div class="card">
                <h2>About the Nairobi Excursion</h2>
                <p>Discover the best of Kenya’s vibrant capital — a city where wildlife and culture blend
                    beautifully.
                    Experience close encounters with giraffes, explore Nairobi National Park, and immerse
                    yourself in Kenya’s
                    rich traditions at Bomas of Kenya. Perfect for families, couples, and solo travelers seeking
                    authentic
                    adventure in a single day.</p>
            </div>
            <div class="card">
                <h4>Contact</h4>
