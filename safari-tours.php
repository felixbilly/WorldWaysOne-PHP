    ...
    <style>
        ...
        .hero {
            ...
            background:
                ...
                url('images/ewaso-river-samburu.jpg') center/cover no-repeat;
            padding: 90px 20px;
            color: #fff;
            text-align: left;
...
<body>
    ...
    <section class="hero">
        <div class="content">
            <p>Home &raquo; Tours &raquo; Safari Adventures</p>
            <h1>Safari Adventures</h1>
            <span class="pill">Wildlife • Luxury • Discovery</span>
        </div>
    </section><br>
    ...
    <section class="scroll-gallery">
        <div class="scroll-track">
            ...
            <div class="gallery-item">
                <img src="images/camp-de.webp" alt="Pilgrimage Group">
                <span>Safari camps</span>
            </div>

            <div class="gallery-item">
                <img src="images/safari1.jpg" alt="Pilgrimage Group">
                <span>Safari-Lodge</span>
            </div>

            <div class="gallery-item">
                <img src="images/park-main-gate.jpeg" alt="Pilgrimage Group">
                <span>Nairobi National Park</span>
            </div>

            <div class="gallery-item">
                <img src="images/Lewa-wildlife-Conservancy.jpg" alt="Pilgrimage Group">
                <span>Lewa-wildlife-Conservancy</span>
            </div>

            <div class="gallery-item">
                <img src="images/swimming-pool-private-safari.jpg" alt="Pilgrimage Group">
            ...
            <div class="gallery-item">
                <img src="images/safari1.jpg" alt="Pilgrimage Group">
                <span><Safari-Lodge></Safari-Lodge></span>
            </div>

            <div class="gallery-item">
                <img src="images/park-main-gate.jpeg" alt="Pilgrimage Group">
                <span>Nairobi National Prak</span>
            </div>
    ...
    <section class="content-section">
        <article class="post">
            <h2>Discover the Wild Heart of Africa</h2>
            <p class="lead">
                Each safari adventure is designed for discovery and comfort — blending untamed nature with five-star
                hospitality. Witness breathtaking sunsets, roaring lions, and elephants crossing the savannah, while
                relaxing in lodges that redefine luxury in the wild.
            </p>
            <div class="card">
                <h3>Highlights</h3>
                <ul style="line-height:1.8;color:var(--muted)">
                    <li>Guided 4x4 game drives in top reserves like Maasai Mara, Serengeti & Kruger.</li>
                    <li>Stay in luxury lodges or tented camps with panoramic views.</li>
                    <li>Hot-air balloon safaris at sunrise over the plains.</li>
                    <li>Private bush dinners and sundowners.</li>
                    <li>Optional beach extension in Zanzibar or Seychelles.</li>
                </ul>
                </p>
            </div><br>
            ...
            <section class="itinerary">
                ...
                <div class="day">
                    <div class="day-header">Day 1: Arrival in Nairobi / Arusha<span>+</span>
                    </div>
                    <div class="day-content">
                        Arrive at Jomo Kenyatta or Kilimanjaro International Airport and
                        transfer to your hotel for overnight. Safari briefing and welcome dinner.<br>

                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Day 2–3: Maasai Mara National Reserve<span>+</span></div>
                    <div class="day-content">
                        Fly or drive to the iconic Mara. Morning and evening game drives
                        to spot lions, elephants, cheetahs, and more. Optional hot-air balloon ride.<br>

                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Day 4–5: Serengeti National Park<span>+</span></div>
                    <div class="day-content">
                        Cross into Tanzania for the endless Serengeti plains. Watch
                        wildebeest migrations and enjoy sundowners overlooking acacia-dotted landscapes.<br>

                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Day 6: Ngorongoro Crater<span>+</span></div>
                    <div class="day-content">
                        Descend into the world’s largest intact caldera — home to over
                        25,000 animals, including rhinos and flamingos. Picnic lunch by the crater floor.<br>

                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Day 7–8: Lake Manyara or Tarangire <span>+</span></div>
                    <div class="day-content">
                        Enjoy the tranquil beauty of Lake Manyara or elephant herds of
                        Tarangire before heading back to Arusha.<br>

                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Optional: Zanzibar Beach Extension <span>+</span></div>
                    <div class="day-content">
                        End your safari with relaxation on white sandy beaches, spice
                        tours, and ocean sunsets in Zanzibar or Seychelles.<br>
        ...
        <aside class="sidebar">
            <div class="card">
                <h3>Safari Information</h3>
                <ul>
                    <li><strong>Duration:</strong> 7 to 12 days</li>
                    <li><strong>Destinations:</strong> Kenya, Tanzania, Botswana, South Africa</li>
                    <li><strong>Travel Style:</strong> Private / Group / Family</li>
                    <li><strong>Includes:</strong> Game drives, Accommodation, Transfers, Meals</li>
                </ul>
            </div>
            ...
            <div class="card">
                ...
                <p>
                    Experience Africa’s great wilderness up close — from the endless plains of the Serengeti to
                    the dramatic landscapes of Maasai Mara and the Okavango Delta. Enjoy luxury lodges,
                    private 4x4 game drives, and expert guides bringing you face-to-face with Africa’s Big Five.
                </p>
            </div>
            <div class="card">
                <h4>Contact</h4>
    ...
    <section class="related-tours py-5 pilgrim-slider-section">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="tour-card">
                        <img src="images/ambos.webp" alt=" " class="img-fluid tour-img">
                        <div class="tour-body">
                            <h5>Custom Tours</h5>
                            ...
                            <a href="other-destinations.php" class="btn btn-success btn-sm px-3">View Details</a>
                        </div>
                    </div>
                </div>
