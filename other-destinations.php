    ...
    <style>
        ...
        .hero {
            ...
            background:
                ...
                url('images/Banner-Kenya.webp') center/cover no-repeat;
            padding: 90px 20px;
            color: #fff;
            text-align: left;
...
<body>
    ...
    <section class="hero">
        <div class="content">
            <p>Home &raquo; Kenya Tours &raquo; Other Custom Destinations</p>
            <h1>Other Custom Kenya Destinations</h1>
            <span class="pill">Adventure • Culture • Nature Escapes</span>
        </div>
    </section><br>
    ...
    <section class="scroll-gallery">
        <div class="scroll-track">
            ...
            <div class="gallery-item">
                <img src="images/ambos.webp" alt="Pilgrimage Group">
                <span>Amboseli</span>
            </div>

            <div class="gallery-item">
                <img src="images/Safari_Camp-1.jpg" alt="Pilgrimage Group">
                <span>Safari Camp</span>
            </div>

            <div class="gallery-item">
                <img src="images/samburu-safari.png" alt="Pilgrimage Group">
                <span>Samburu Adventure</span>
            </div>

            <div class="gallery-item">
                <img src="images/safari.jpg" alt="Pilgrimage Group">
                <span> lewa-Laikipia</span>
            </div>

            <div class="gallery-item">
                <img src="images/swimming-pool-private-safari.jpg" alt="Pilgrimage Group">
                <span>Samburu Lodge</span>
            </div>
    ...
    <section class="content-section">
        <article class="post">
            <h2>Explore Kenya’s Hidden Treasures</h2>
            <p class="lead">Kenya is more than safaris and beaches — it’s culture, mountain trails, and lakeside
                serenity.
                From flamingo-filled lakes to the foothills of Africa’s second-highest peak, we design flexible trips to
                match
                your sense of discovery.</p>
            <div class="card">
            ...
            <section class="itinerary">
                ...
                <div class="day">
                    <div class="day-header">Day 1: Nairobi – Lake Naivasha<span>+</span>
                    </div>
                    <div class="day-content">
                        Depart from Nairobi, stopping at the Great Rift Valley viewpoint before reaching Naivasha. Enjoy
                        a boat
                        ride among hippos and birdlife, or bike through Hell’s Gate National Park.<br>

                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Day 2: Mt. Kenya Region<span>+</span></div>
                    <div class="day-content">
                        Travel north to Mt. Kenya region. Enjoy hiking, waterfalls, and tea farm visits with views of
                        Africa’s
                ...
                <div class="day">
                    <div class="day-header">Day 3: Cultural Immersion in Samburu<span>+</span></div>
                    <div class="day-content">
                        Drive to Samburu — meet the Samburu people, experience their traditions, and take an evening
                        game
                        drive in
                        the reserve famous for unique northern species<br>
        ...
        <aside class="sidebar">
            <div class="card">
                ...
                <ul>
                    <li><strong>Duration:</strong> 2 - 5 Days (Customizable)</li>
                    <li><strong>Departure:</strong> Nairobi</li>
                    <li><strong>Destinations:</strong> Naivasha, Mt. Kenya, Amboseli, Samburu</li>
                    <li><strong>Includes:</strong> Transport, Park Fees, Accommodation, Guide</li>
                </ul>
            </div>

            <div class="card">
                <h2>About the Custom Tours</h2>
                <p>Looking for something off the beaten path? Our custom tours take you beyond the city — from
                    the lakes of
                    the Rift Valley to the majestic slopes of Mt. Kenya, and deep into the cultural heartlands
                    of Samburu and
                    Maasai villages. Tailor your Kenyan adventure to suit your style — adventure, relaxation, or
                    heritage
                    exploration.</p>
            </div>
            <div class="card">
