    ...
    <style>
        ...
        .hero {
            ...
            background:
                ...
                url('images/Fatima banner.webp') center/cover no-repeat;
            padding: 90px 20px;
            color: #fff;
            text-align: left;
...
<body>
    ...
    <section class="hero">
        <div class="content">
            <p>Home &raquo; World Travel &raquo; Europe Pilgrimage</p>
            <h1>Europe Pilgrimage</h1>
    ...
    <section class="scroll-gallery">
        <div class="scroll-track">
            ...
            <div class="gallery-item">
                <img src="images/sistine.jpg" alt="Pilgrimage Group">
                <span>Rome - Vatican City</span>
            </div>

            <div class="gallery-item">
                <img src="images/Lorrain.webp" alt="Pilgrimage Group">
            ...
            <div class="gallery-item">
                <img src="images/group.webp" alt="Pilgrimage Group">
            ...
            <div class="gallery-item">
                <img src="images/italy greese.jpeg" alt="Pilgrimage Group">
                <span>Mt. Titlis - Switzerland</span>
            </div>
    ...
    <section class="content-section">
        <article class="post">
            <h2>FEATURING: FATIMA 100TH ANNIVERSARY — Rome, Assisi, Padua, Turin, Avila, Lourdes, Fatima, Lisbon</h2>

            <p class="lead">
                The purpose of this pilgrimage is to encounter Christ through His Church — in the sacred places we
                visit, in
                the lives of saints whose faith shaped history, and in the fellowship of pilgrims who walk this path
                together.
                Each destination invites reflection, renewal, and a deeper love for our faith.
            </p>
            <div class="card">
                <h3>Trip Highlights</h3>
                <ul style="line-height:1.8;color:var(--muted)">
                    <li>Visit the Vatican, St. Peter’s Basilica, and Sistine Chapel.</li>
                    <li>Pilgrimage to Marian Shrines — Lourdes & Fatima.</li>
                    <li>Explore Assisi, home of St. Francis, and Avila, the city of St. Teresa.</li>
                    <li>Celebrate Mass daily in historic cathedrals and chapels.</li>
                    <li>Walk the Stations of the Cross in Fatima and attend the Candlelight Procession.</li>
                </ul>
            </div><br>
            ...
            <section class="itinerary">
                ...
                <div class="day">
                    <div class="day-header">Day 1–2: Departure & Arrival in Rome<span>+</span>
                    </div>
                    <div class="day-content">
                        Depart Nairobi for Rome. On arrival, visit St. Peter’s Basilica
                        and the Vatican Museum. Celebrate your first Mass in the Eternal City.<br>
                        <!-- <strong>Meals:</strong> Dinner -->
                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Day 3: Assisi<span>+</span></div>
                    <div class="day-content">
                        Travel to Assisi, home of St. Francis and St. Clare. Visit their
                        tombs and enjoy a reflective walk through the medieval town.<br>
                        <!-- <strong>Meals:</strong> Breakfast, Lunch, Dinner -->
                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Day 4–5: Padua & Venice<span>+</span></div>
                    <div class="day-content">
                        Visit the Basilica of St. Anthony in Padua, then enjoy a short
                        excursion to Venice — the city of canals — before evening prayers.
                        <!-- excursions — designed for your pace and preferences.<br> -->

                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Day 6–8: Turin & Avila<span>+</span></div>
                    <div class="day-content">
                        Discover the Cathedral of Turin, where the Holy Shroud is
                        preserved. Continue to Avila, home of St. Teresa, and join in Mass at the convent.<br>
                        <!-- <strong>Meals:</strong> Breakfast, Lunch, Dinner  -->
                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Day 9–11: Lourdes, France<span>+</span></div>
                    <div class="day-content">
                        Spend time in prayer at the Grotto of Massabielle where Our Lady
                        appeared to St. Bernadette. Participate in the Candlelight Procession and Stations of the
                        Cross<br>
                        <!-- <strong>Meals:</strong> Breakfast, Lunch, Dinner  -->
                    </div>
                </div>
                ...
                <div class="day">
                    <div class="day-header">Day 12–14: Fatima & Lisbon <span>+</span></div>
                    <div class="day-content">
                        Visit the Shrine of Our Lady of Fatima, the homes of Jacinta and
                        Francisco, and the Basilica of the Holy Trinity. Explore Lisbon before departure.<br>

                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Day 15: Return to Nairobi<span>+</span></div>
                    <div class="day-content">
                        After breakfast, depart for the airport for your flight back
                        home. End of a blessed pilgrimage.<br>
                        <!-- <strong>Meals:</strong> Breakfast, Lunch, Dinner -->
                    </div>
                </div>
        ...
        <aside class="sidebar">
            <div class="card">
                ...
                <ul>
                    ...
                    <li><strong>Destinations:</strong> Rome, Lourdes, Fatima, Avila, Lisbon</li>
                    <li><strong>Includes:</strong> Flights, Accommodation, Tours, Meals</li>
                </ul>
            </div>
