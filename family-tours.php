    ...
    <style>
        ...
        .hero {
            ...
            background:
                ...
                url('images/avif.png') center/cover no-repeat;
            padding: 90px 20px;
            color: #fff;
            text-align: left;
...
<body>
    ...
    <section class="hero">
        <div class="content">
            <p>Home &raquo; Tours &raquo; Private & Family Tours</p>
            <h1>Private & Family Tours</h1>
            <span class="pill">Luxury, Cultural & Beach Escapes</span>
        </div>
    </section><br>
    ...
    <section class="scroll-gallery">
        <div class="scroll-track">
            <div class="gallery-item">
                <img src="images/kenya-family.jpg" alt="Pilgrimage Group">
                <span> </span>
            </div>

            <div class="gallery-item">
                <img src="images/family-trip.jpg" alt="Pilgrimage Group">
                <span> </span>
            </div>
    ...
    <section class="content-section">
        <article class="post">
            <h2>Explore. Connect. Relax.</h2>
            <p class="lead">
                Each tour is carefully curated to balance exploration, adventure, and relaxation — ensuring
                unforgettable
                moments for couples, families, and friends. Enjoy cultural city tours, private safaris, and tropical
                island
                retreats with seamless arrangements from start to finish.
            </p>
            <div class="card">
                <h3>Highlights</h3>
                <ul style="line-height:1.8;color:var(--muted)">
                    <li>Private game drives and luxury lodges in Kenya or Tanzania.</li>
                    <li>Cultural experiences in Morocco, Egypt, and South Africa.</li>
                    <li>Romantic beach getaways in Zanzibar, Seychelles, and Mauritius.</li>
                    <li>City tours and desert safaris in Dubai and Abu Dhabi.</li>
                    <li>Relaxation and spa retreats in the Maldives or Greece.</li>
                </ul>
            </div><br>
            ...
            <section class="itinerary">
                ...
                <div class="day">
                    <div class="day-header">Day 1: Arrival & Welcome Dinner<span>+</span>
                    </div>
                    <div class="day-content">
                        Arrive at your destination and transfer to your luxury hotel or
                        villa. Enjoy a welcome dinner overlooking the ocean or city skyline.<br>
                        <!-- <strong>Meals:</strong> Dinner -->
                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Day 2: City or Cultural Exploration<span>+</span></div>
                    <div class="day-content">
                        Explore iconic landmarks, local markets, and cultural attractions
                        with a private guide — from the Souks of Marrakech to the heritage sites of Nairobi..<br>
                        <!-- <strong>Meals:</strong> Breakfast, Lunch, Dinner -->
                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Day 3–5: Adventure & Discovery<span>+</span></div>
                    <div class="day-content">
                        Experience guided safaris, dhow cruises, desert drives, or island
                ...
                <div class="day">
                    <div class="day-header">Day 6–7: Relaxation & Leisure<span>+</span></div>
                    <div class="day-content">
                        Unwind at the spa, enjoy water sports, or simply relax by the
                        beach with sunset cocktails and fresh seafood dinners.<br>
                        <!-- <strong>Meals:</strong> Breakfast, Lunch, Dinner  -->
                    </div>
                </div>

                <div class="day">
                    <div class="day-header">Final Day: Departure<span>+</span></div>
                    <div class="day-content">
                        Enjoy a leisurely breakfast before your airport transfer.
                        Depart with unforgettable memories — until next time!<br>
                        <!-- <strong>Meals:</strong> Breakfast, Lunch, Dinner  -->
                    </div>
                </div>
        ...
        <aside class="sidebar">
            <div class="card">
                ...
                <ul>
                    <li><strong>Duration:</strong> Flexible — from 3 days to 14 days</li>
                    <li><strong>Destinations:</strong> Kenya, Zanzibar, Seychelles, Dubai, Maldives, Mauritius
                    </li>
                    <li><strong>Travel Style:</strong> Private / Family / Group</li>
                    <li><strong>Includes:</strong> Flights, Accommodation, Transfers, Guided Tours</li>
                </ul>
            </div>
            ...
            <div class="card">
                ...
                <p>
                    Discover the world your way — with personalized travel experiences designed around your
                    preferences. Whether it’s a relaxing beach escape in Zanzibar, an adventure through Kenya’s
                    national parks, or a luxury getaway in the Maldives, our private and family tours deliver
